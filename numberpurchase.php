...
// This variable is set to be the ID that you entered on the Number Management page in the Purchase section.
$purchase = check_input($_POST['purchase']);
...
// Replace what's between <key>YOUR_KEY_HERE</key> with your key to send a message.
	$msg3 = '<request>
  <key>'.$key.'</key>
  <numbers action="purchase">'.$purchase.'</numbers>
</request>';
